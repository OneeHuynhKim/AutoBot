            ...
            <main className="grow w-full flex items-center justify-center p-4 md:p-8 relative z-10">
                ...
                <div className="w-full max-w-[1600px] grid grid-cols-1 lg:grid-cols-12 gap-0 overflow-hidden rounded-[40px] backdrop-blur-xl bg-white/5 ring-1 ring-white/10 shadow-2xl min-h-[600px]">
                    ...
                    {!isCreateWallet ? (
                        ...
                        >
                            <div className="lg:col-span-7 p-10 md:p-16 bg-white/95 backdrop-blur-2xl flex flex-col justify-center h-full">
                                <div className="max-w-2xl mx-auto w-full">
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <button
                                            ...
                                            onClick={() => setIsCreateWallet(true)}
                        ...
                        >
                            <div className="lg:col-span-7 p-10 md:p-16 bg-white/95 backdrop-blur-2xl flex flex-col justify-center h-full">
                                <div className="max-w-2xl mx-auto w-full">
                                    <div className="mb-10">
                                        <h3 className="text-3xl font-bold text-slate-900 mb-2">Thiết lập PIN cho ví</h3>
                                        <p className="text-slate-500 text-base">Thiết lập mã PIN để tăng bảo mật cho giao dịch của bạn.</p>
                                    </div>
